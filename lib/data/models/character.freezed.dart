...
class _$_Character with DiagnosticableTreeMixin implements _Character {
  const _$_Character({required final List<Results> results, required this.info})
      : _results = results;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Character(results: $results, info: $info)';
  }
...
abstract class _Character implements Character {
  const factory _Character(
      ...
      required final Info info}) = _$_Character;
